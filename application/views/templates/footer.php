    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col l3 s12">
                ...
                <ul>
                    <li><i class="material-icons left">location_on</i><strong>Los Ángeles</strong>
                        <br>
                        <a class="white-text hoverable"
                            ...
                            Av. Almirante Latorre 0780</a>
                    </li>
                    <br>
                    <li><i class="material-icons left">location_on</i><strong>Las Condes, Santiago</strong>
                        <br>
                        <a class="white-text hoverable"
                            ...
                            Vitacura 2939 Of. 301</a>
                    </li>
                    <br>
                    <li><i class="material-icons left">location_on</i><strong>Valdivia</strong>
                        <br>
                        <a class="white-text hoverable"
