...
<div class="container text-center mt-5">
    ...
    <form class="form-signin">
        ...
        <div class="checkbox mb-3">
            <label>
                <input type="checkbox"  value="remember-me"><spam class="text-white">Recuérdame</spam>
            </label>
        </div>
        <button class="btn btn-lg btn-primary btn-block text-white" onclick="ej()" type="submit">Iniciar sesión</button>
    </form>
        </div>
    </div>
</div>
        ...
        <div class="container-fluid rounded-top py-3" style="background: rgb(255,255,255,0.5);">
            <div class="row">
                <div class="col">
                    ...
                    <div class="middle"><a href="https://www.vvsecurity.cl:2096/" class="btn btn-Primary">Ir a WebMail</a></div>
                </div>
                <div class="col">
                    <img src="<?php echo base_url() ?>assets/img/Tecnologia.png" alt="" class="img-fluid">
                    <div class="middle"><a href="http://vvsecurity.duckdns.org/"class="btn btn-Primary">Ir a SoftGuard</a></div>
                </div>
                <div class="col">
                    <img src="<?php echo base_url() ?>assets/img/Laudus.png" alt="" class="img-fluid">
                    <div class="middle"><a href="https://erp.laudus.cl/PortalEmpleados/"class="btn btn-Primary">Ir a Laudus</a></div>
                </div>
                <div class="col">
                  <img src="<?php echo base_url() ?>assets/img/ControlRoll.png" alt="" class="img-fluid">  
                  <div class="middle"><a href="https://www.controlroll.com/login.aspx"class="btn btn-Primary">Ir a Control Roll</a></div>
                </div>
                <div class="col">
                  <img src="<?php echo base_url() ?>assets/img/WebMaster.png" alt="" class="img-fluid">  
                  <div class="middle"><a href="https://www.vvsecurity.cl/wp-login.php"class="btn btn-Primary">Ir a Web Master</a></div>
                </div>  
            </div>
        </div>
</body>
