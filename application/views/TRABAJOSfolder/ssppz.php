...
<br>
<br>
<h2 class="text-center h2 text-white my-5">Formulario de postulación de Supervisor de Seguridad</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form>
                ...
                <!-- OS10 -->
                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="comuna">Estado de su Curso de Supervisor</label>
                ...
                <div class="card-body row">
                    <div class="col-4">
                        ...
                        <div class="border p-3 text-center">
                            <p class="border-bottom">Curso de supervisor</p>
                            <div id="Check">
