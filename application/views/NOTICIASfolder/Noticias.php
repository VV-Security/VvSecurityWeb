 ...
 */
  ...
  <Section  id="Recientes">
        ...
        <div v-if="index != 1" class="jumbotron col-md-12 p-4 p-md-5 text-white rounded" :style="'background-image: url('+r.img+'); background-repeat: no-repeat; background-size: cover;'">  
        <div class="col-md-6 px-0" style="background-color: rgb(0,0,0,0.5);">
                ...
                <p class="lead mb-0"><a :href="'http://localhost/VvSecurityWeb/index.php/Noticias'+'/'+r.Nombre.replaceAll(' ','_')+'/'+r.Titulo.replaceAll(' ','_')" class="text-white font-weight-bold">Continua leyendo...</a></p>
            </div>
        </div>
